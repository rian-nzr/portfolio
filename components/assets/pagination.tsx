export default function Pagination() {
    return(
        ...
        <div className="flex items-center justify-center ">
            <div className="w-full  flex items-center justify-between border-t border-gray-200 dark:border-gray-800">
               ...
               <div className="sm:flex hidden">
                  ...
                  <p className="text-sm font-medium leading-none cursor-pointer text-blue-700 border-t border-blue-600 pt-3 mr-4 px-2">4</p>
